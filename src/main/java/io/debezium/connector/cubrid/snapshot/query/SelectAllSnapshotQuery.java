 ...
 */
package io.debezium.connector.cubrid.snapshot.query;
...
import io.debezium.connector.cubrid.CubridConnector;
import io.debezium.snapshot.spi.SnapshotQuery;

/** The default {@code select_all} snapshot query (Postgres mirror). */
@ConnectorSpecific(connector = CubridConnector.class)
